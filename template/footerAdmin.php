    ...
    <!-- Page level plugins -->
    <script src="../admin/ASSET/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="../admin/ASSET/vendor/datatables/dataTables.bootstrap4.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="../admin/ASSET/js/demo/datatables-demo.js"></script>
